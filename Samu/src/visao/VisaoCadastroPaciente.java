...
public class VisaoCadastroPaciente extends JPanel {
    ...
    private JComboBox jComboBoxTipoSanguineo;
    ...
    public JLabel getJLabelSessao ( ) {
    	...
    	if (labelSessao == null) {
    		...
    		labelSessao = new JLabel ("Cadastro do Paciente");
	...
	public JTextField getJTextFieldFiliacao() {
		if (jTextFieldFiliacao == null) {
			...
			jTextFieldFiliacao.setBounds(480, 170, 180, 20);
		}
		return jTextFieldFiliacao;
	}
	public JLabel getLblEspecialidade() {
		if (lblEspecialidade == null) {
			lblEspecialidade = new JLabel("Tipo Sangu\u00EDneo");
	...
	public JLabel getLblreaDeAtuao() {
		if (lblreaDeAtuao == null) {
			lblreaDeAtuao = new JLabel("Flia\u00E7\u00E3o");
	...
	public JComboBox getJComboBoxTipoSanguineo() {
		if (jComboBoxTipoSanguineo == null) {
			jComboBoxTipoSanguineo = new JComboBox();
			jComboBoxTipoSanguineo.setBounds(480, 119, 85, 21);
			jComboBoxTipoSanguineo.addItem("Selecione");
		}
		return jComboBoxTipoSanguineo;
	}
	
	public void atualizaComboBoxTipoSanguineo () {
		
		getJComboBoxTipoSanguineo().removeAllItems();
		getJComboBoxTipoSanguineo().addItem("Selecione");
		
		jComboBoxTipoSanguineo.addItem("A+");
		jComboBoxTipoSanguineo.addItem("A-");
		jComboBoxTipoSanguineo.addItem("B+");
		jComboBoxTipoSanguineo.addItem("B-");
		jComboBoxTipoSanguineo.addItem("O+");
		jComboBoxTipoSanguineo.addItem("O-");
		jComboBoxTipoSanguineo.addItem("AB+");
		jComboBoxTipoSanguineo.addItem("AB-");
	}
}